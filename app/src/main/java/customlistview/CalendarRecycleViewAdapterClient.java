...
public class CalendarRecycleViewAdapterClient extends RecyclerView.Adapter<CalendarRecycleViewAdapterClient.ViewHolder> {
    ...
    public CalendarRecycleViewAdapterClient(ArrayList<String> daysOfMonth, OnItemListener onItemListener, int displayedMonth, int displayedYear) {
...
//            }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView, CalendarRecycleViewAdapterClient.OnItemListener onItemListener) {
            super(itemView);
